...
version = sigmaepsilon.__version__
# The full version, including alpha/beta/rc tags.
release = sigmaepsilon.__version__ + '-git'
...
latex_documents = [
    ('index', 'sigmaepsilon.tex', u'SigmaEpsilon Documentation',
...
man_pages = [
    ('index', 'sigmaepsilon', u'SigmaEpsilon Documentation',
     [u'Bence Balogh'], 1)
]
...
texinfo_documents = [
    ('index', 'sigmaepsilon', u'SigmaEpsilon Documentation',
     u'Bence Balogh', 'SigmaEpsilon', 'One line description of project.',
     'Miscellaneous'),
]
...
sphinx_gallery_conf = {
    ...
    #'junit': os.path.join('sigmaepsilon', 'junit-results.xml'),
