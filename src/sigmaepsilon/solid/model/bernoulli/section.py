...
def generate_mesh(geometry: Geometry, *, l_max: float = None, a_max: float = None, 
...
def get_section(shape, *args, mesh_params: dict = None, material: Material = None,
...
class BeamSection(Wrapper):
    ...
    **kwargs : dict, Optional
    ...
    def calculate_section_properties(self, separate=False):
        """
    ...
    def model_stiffness_matrix(self, E=None, nu=None) -> np.ndarray:
        """
